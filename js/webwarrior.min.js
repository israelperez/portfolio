/* Web Warrior Israel Perez 24-05-2015 */
var UIEngine = {
    init: function() {
    ...
    _sendEmail: function() {
        var Engine = this, formData = Engine._formElements.form.serialize();
        $.ajax({
            type: "POST",
            url: "sendEmail.php",
            data: formData
    ...
    _validateContact: function() {
        var Engine = this, errString = "", isValidForm = true, validateName = function() {
