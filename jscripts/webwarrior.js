	...
	_sendEmail: function(){
		...
		$.ajax({
			...
			if(data.status == 'success'){
				Engine._formElements.formMsg.removeClass('error').addClass('success').html('Thank You! Your message has been sent');
				Engine._formElements.form[0].reset();
			}else{
				Engine._formElements.formMsg.removeClass('success').addClass('error').html('An error occured and your message could not be sent');
			...
			if (data.responseText !== '') {
				...
				errorMsg = 'Oops! An error occured and your message could not be sent. <br>Please email me at israel@webwarrior.me about this error';
			}
